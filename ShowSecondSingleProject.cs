...
namespace HRD
{
    public partial class ShowSecondSingleProject : Form
    {
        public ShowSecondSingleProject(string id_p)
        {
            this.id_p = id_p;
            InitializeComponent();
        }
        ...
        private void ShowSecondSingleProject_Load(object sender, EventArgs e)
        {
